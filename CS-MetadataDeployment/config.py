...
EXCHANGE_TOKEN_URL = 'https://{cp4ba-host}/v1/preauth/validateAuth' #Token exchange URL
#---------------------------------------------------------------------------------#
...
#This values are necessary only IF using IDP/SCIM
TARGET_EXCHANGE_TOKEN_URL = 'https://{cp4ba-host}/v1/preauth/validateAuth' #Token exchange URL
#---------------------------------------------------------------------------------#
# Basic Auth
...
#---------------------------------------------------------------------------------#
#Change variables in this block to match with the max level of Choice List values need to be queried on source system
MAX_LEVEL_CVL = 4
#---------------------------------------------------------------------------------#
...
TOKEN_LIFETIME = 1800 #Time before token expires
#---------------------------------------------------------------------------------#
