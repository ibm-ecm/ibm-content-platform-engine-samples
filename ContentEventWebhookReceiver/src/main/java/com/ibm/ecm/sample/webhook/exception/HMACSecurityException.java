 ...
 * {@code RuntimeException} is sufficient.
 */
public class HMACSecurityException extends RuntimeException {

    private static final long serialVersionUID = -74473082863742381L;
