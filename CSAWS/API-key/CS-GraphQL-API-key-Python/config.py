...
##Replace all variables noted as REPLACE to match with system configuration##
...
#Change variables in this block to match with APIC
#---------------------------------------------------------------------------------#

APIC_TOKEN_URL = 'REPLACE' # https://api-9o4.us-east-a.apiconnect.ibmappdomain.cloud/ibmcontentservices/csprod/${InstanceName}/token
