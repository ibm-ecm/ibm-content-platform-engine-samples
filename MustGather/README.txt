...
Interactive Mode
If you wish to reconfigure the config file, you can either directly edit the config file or run the scripts with the -i flag. This flag can be combined with any other keywords mentioned below, which will then prompt the user for any necessary config values needed to run.
./linux-script.sh -i
